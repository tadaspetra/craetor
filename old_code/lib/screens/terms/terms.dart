      ...
      body: ListView(
        ...
        children: <Widget>[
          Container(
            ...
            child: Text("Last Updated October 29, 2019",
          ...
          Container(
            ...
            child: Text(
              'These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) ' +
                  'and Craetor Network ("Company", “we”, “us”, or “our”), concerning your access to and use of the creator.com website as well as any ' +
                  'other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, ' +
                  'the “Site”). You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use. ' +
                  ...
                  'You will be subject to, and will be deemed to have been made aware of and to have accepted, the changes in any revised Terms of Use by ' +
                  ...
                  'under the age of 18) must have the permission of, and be directly supervised by, their parent or guardian to use the Site. If you are a minor, you ' +
          ...
          Container(
            alignment: Alignment.centerLeft,
            child:
                Text('6.  Use a buying agent or purchasing agent to make purchases on the Site. '),
          ),
          Container(
            alignment: Alignment.centerLeft,
            child: Text('7.  Engage in unauthorized framing of or linking to the Site. '),
          ),
          Container(
            alignment: Alignment.centerLeft,
            child: Text(
          ...
          Container(
            alignment: Alignment.centerLeft,
            child: Text('11.  Sell or otherwise transfer your profile. '),
          ),
          Container(
            alignment: Alignment.centerLeft,
            child: Text(
          ...
          Container(
            alignment: Alignment.centerLeft,
            child: Text('4.  Your Contributions are not false, inaccurate, or misleading.'),
          ),
          Container(
            alignment: Alignment.centerLeft,
            child: Text(
          ...
          Container(
            alignment: Alignment.centerLeft,
            child: Text(
              'Any legal action of whatever nature brought by either you or us (collectively, the “Parties” and individually, a “Party”) shall be commenced or prosecuted in the state and federal courts located in United States County, Illinois, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction and forum non conveniens with respect to venue and jurisdiction in such state and federal courts. Application of the United Nations Convention on Contracts for the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) are excluded from these Terms of Use. In no event shall any claim, action, or proceeding brought by either Party related in any way to the Site be commenced more than two (2) years after the cause of action arose.',
            ),
          ),
          SizedBox(height: 20.0),
          //CORRECTIONS  -------------------------------------------------------
